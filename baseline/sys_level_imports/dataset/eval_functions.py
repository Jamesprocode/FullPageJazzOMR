from sys_level_imports.metrics import levenshtein
...
def compute_poliphony_metrics(hyp_array, gt_array):
    ...
    for h_string, gt_string in zip(hyp_array, gt_array):
        ...
        hyp_ser.append(
            parse_krn_content(h_string, ler_parsing=False, cer_parsing=False)
        )
        gt_ser.append(
            parse_krn_content(gt_string, ler_parsing=False, cer_parsing=False)
        )
